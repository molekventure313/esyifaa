...
export default function RawatSendiriHeroSection() {
    ...
    <section style={{
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          🛡️ ESyifaa · Berhenti Bergantung Pada Perawat
        </div>
        ...
        <h1 style={{
          ...
          Dah Habis Berapa Ribu Ringgit{' '}
          <span style={{ color: '#FDE047' }}>Berjumpa Perawat?</span>
          {' '}Tiba Masa Rawat Sendiri.
        </h1>
        ...
        <p style={{
          ...
          Setiap kali ada masalah, kena PM perawat. Tunggu slot. Bayar lagi.
          Masalah berulang.{' '}
          <strong style={{ color: '#FEF3C7' }}>Habis ribuan ringgit — tapi belum selesai-selesai.</strong>
        </p>
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '1rem', color: '#FEF3C7', lineHeight: 1.65, fontWeight: 600 }}>
            ...
            — ibarat ada <em>perawat peribadi</em> dalam genggaman sendiri.
            <span style={{ color: '#4ADE80' }}>{' '}Rawat diri &amp; keluarga tanpa had. Seumur hidup. Tanpa kos tambahan.</span>
          </p>
        </div>
        ...
        <div style={{
          ...
          {[
            '🛡️ Rawat Sendiri Bila-Bila Masa',
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.62rem', color: '#FDE047', fontWeight: 800, letterSpacing: '0.04em', marginTop: '0.2rem', textAlign: 'center', lineHeight: 1.3 }}>
            RAWAT SENDIRI
          </span>
        </div>
