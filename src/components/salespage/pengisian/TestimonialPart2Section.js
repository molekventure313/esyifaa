...
const TESTIMONIALS_PART2 = [
  {
    ...
    location: 'Ipoh, Perak',
    time: '6 hari lepas',
    tag: '👧 Anak Histeria → Tidur Nyenyak',
  ...
  },
  {
    ...
    location: 'Kedah',
    time: '1 minggu lepas',
    tag: '🧠 Bisikan Was-Was → Fikiran Lapang',
  ...
  },
  {
    ...
    time: '1 minggu lepas',
    tag: '🏪 Premis Niaga Tersekat → Pelanggan Ramai Semula',
  ...
  },
  {
    ...
    location: 'Pahang',
    time: '2 minggu lepas',
    tag: '💰 Jimat Ribuan Ringgit Yuran Rawatan',
  ...
  },
  {
    ...
    location: 'Terengganu',
    time: '2 minggu lepas',
    tag: '🔄 Pelarasan Mingguan → Aura Sentiasa Kuat',
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.75rem' }}>
          ...
          <h2 style={{
            ...
            Masih Ragu? Lihat Lagi Mereka Yang Telah Memperoleh Ketenangan
          </h2>
          <p style={{ fontSize: '0.95rem', color: '#64748B', lineHeight: 1.65, maxWidth: '540px', margin: '0 auto' }}>
            Dari masalah histeria anak, rumahtangga retak, bisikan was-was hingga premis perniagaan — Al-Quran adalah penyembuh mutlak.
          </p>
        </div>
        <div style={{
          display: 'grid',
